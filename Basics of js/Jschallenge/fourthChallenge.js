...
if(johnObject.bmi === maryObject.bmi){
    console.log("John Bmi "+ johnObject.bmi +" is equal to Mary Bmi i-e "+ maryObject.bmi);
}else if(johnObject.bmi > maryObject.bmi){
    console.log("John Bmi "+ johnObject.bmi +" is greater to Mary Bmi i-e "+ maryObject.bmi);
}else{
